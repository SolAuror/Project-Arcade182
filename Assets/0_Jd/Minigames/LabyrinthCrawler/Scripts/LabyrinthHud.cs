...
namespace Sol.Minigames
{
    ...
    public class LabyrinthHud : MonoBehaviour
    {
        ...
        private void ConfigureFloorWave()
        {
            ...
            if (wave == null)
            {
                wave = floorText.gameObject.AddComponent<LabyrinthTextWave>();
            }
    ...
    /// <summary>
    /// Lightweight per-glyph sine wave for the floor banner. LabyrinthHud adds
    /// it at runtime so the authored Text remains straightforward to restyle.
    /// </summary>
    internal sealed class LabyrinthTextWave : BaseMeshEffect
    {

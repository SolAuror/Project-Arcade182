...
namespace Sol.Minigames
{
    ...
    public class LabyrinthExitPad : MonoBehaviour
    {
        ...
        private void Awake()
        {
            // Authored pads carry a trigger; the shared fallback keeps a stage
            // clearable if a future prefab variant loses that collider.
            LabyrinthRuntimeUtility.EnsureSphereTrigger(gameObject, fallbackTriggerRadius);
        }

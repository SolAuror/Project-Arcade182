...
namespace Sol.Minigames
{
    ...
    [AddComponentMenu("Sol/Minigames/Bounce Target")]
    public class BounceTarget : MonoBehaviour
    {
        ...
        private void Awake()
        {
            if (game == null)
            {
                game = FindFirstObjectByType<BounceTargetsGame>();
            }
        ...
        {
            BounceBall ball = collision.rigidbody != null
                ? collision.rigidbody.GetComponent<BounceBall>()
                : collision.collider.GetComponentInParent<BounceBall>();
        ...
        public bool TryHit(BounceBall ball)
        {
            if (hasBeenHit)
            {
                return false;
